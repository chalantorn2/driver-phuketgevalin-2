  ...
  const getStatusBadge = () => {
    if (currentStatus === "idle") {
      ...
      return {
        text: "✅ เสร็จสิ้น",
        className:
          "px-3 py-1 rounded-full text-sm font-medium bg-cyan-100 text-cyan-800",
      };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-cyan-50 flex items-center justify-center">
        <div className="text-center">
          <div className="inline-block w-12 h-12 border-4 border-gray-200 border-t-cyan-600 rounded-full animate-spin mb-4"></div>
      ...
      <div className="p-4 max-w-md mx-auto space-y-4 py-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            ...
            {(job.flight_no_arrival || job.flight_no_departure) && (
              <div className="flex items-start gap-3">
                <i className="fas fa-plane text-cyan-600 mt-1"></i>
                <div>
        ...
        {job.assignment_notes && job.assignment_notes.trim() && (
          <div className="bg-cyan-50 border-2 border-cyan-200 rounded-xl p-4">
            <div className="flex items-center gap-3">
              <i className="fa-solid fa-message text-cyan-600 text-xl"></i>
              <p className="text-sm text-cyan-800 whitespace-pre-wrap flex-1">
          ...
          {currentStatus === "tracking" && (
            <>
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-500 to-cyan-600 text-white py-4 rounded-xl font-semibold text-lg shadow-lg hover:from-cyan-600 hover:to-cyan-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
