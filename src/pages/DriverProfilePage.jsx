          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg">
              ...
              <a
                ...
                className="font-semibold text-gray-900 hover:text-cyan-600 text-xs text-center"
              >
            ...
            <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg">
              <div className="w-8 h-8 bg-cyan-500 rounded-lg flex items-center justify-center mb-1">
                <svg
                  className="w-4 h-4 text-white"
                  fill="none"
                  stroke="currentColor"
